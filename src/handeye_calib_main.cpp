...
#include "handeye_calib_main.hpp"
...
int main(int argc, char** argv) {
	...
	cout << "Usage for calibration is rosrun handeye_calib handeye_calib input_directory write_directory camcali_rwhec flag (no flag -- do both, flag == 0, do camera only camera calibration, flag == 1, do only rwhec). Full path is needed for robot_directory " << endl;
